...
$requete_create_table = 'CREATE TABLE demande_entreprise (nom VARCHAR(100), address VARCHAR(100), phone VARCHAR(100), url VARCHAR(2083), date DATE, statut VARCHAR(100))';
$requete_send_data = 'INSERT INTO demande_entreprise VALUES (:company_name, :company_address, :company_phone, :company_url, NOW(), :statut) ';
